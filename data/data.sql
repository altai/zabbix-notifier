...
insert into parameter(key_, is_email, is_notified, addressees, bound) values ('vm.memory.size[pused]', 1, 1, '[]', 20);
...
insert into parameter(key_, is_email, is_notified, addressees, bound) values ('vm.memory.size[pused]', 0, 1, '[]', 20);
